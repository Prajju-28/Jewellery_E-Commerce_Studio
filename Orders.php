            ...
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item active">
                  <a class="nav-link" href="DealerDashboard.php">Dashboard <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
						...
						while($row = $res->fetch_assoc())
						{
							...
							if($res1->num_rows > 0)
							{
								...
								while($row1 = $res1->fetch_assoc())
								{
									...
									$qr="SELECT dealers_register.DName FROM dealers_register INNER JOIN jewellery_product ON dealers_register.DEmail= jewellery_product.Seller";
									$r=$conn->query($qr);
									if($r->num_rows > 0)
									{										
										while($rww = $r->fetch_assoc())
